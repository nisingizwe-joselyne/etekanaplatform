						...
						<div class="row align-items-center">
							<div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000">
								<div class="owl-carousel owl-theme nav-inside mb-0" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 6000, 'loop': true}">
									<div>
										<img alt="" class="img-fluid" src="{{ asset('front/img/generic/generic-corporate-3-2-full.jpg') }}">
									</div>
									<div>
										<img alt="" class="img-fluid" src="{{ asset('front/img/generic/generic-corporate-3-3-full.jpg') }}">
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<section class="timeline" id="timeline">
								<div class="timeline-body">
									...
									<article class="timeline-box left text-left appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
										...
										<div class="p-2">
											<img alt="" class="img-fluid" src="{{ asset('front/img/history/history-3.jpg') }}" />
									...
									<article class="timeline-box right text-left appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400">
										<div class="timeline-box-arrow"></div>
										<div class="p-2">
											<img alt="" class="img-fluid" src="{{ asset('front/img/history/history-2.jpg') }}" />
									...
									<article class="timeline-box left text-left appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="600">
										<div class="timeline-box-arrow"></div>
										<div class="p-2">
											<img alt="" class="img-fluid" src="{{ asset('front/img/history/history-1.jpg') }}" />
						...
						<div class="row pb-4 mb-2">
								...
								<span class="thumb-info thumb-info-hide-wrapper-bg bg-transparent border-radius-0">
									<span class="thumb-info-wrapper border-radius-0">
										<a href="about-me.html">
											<img src="{{ asset('front/img/team/team-1.jpg') }}" class="img-fluid border-radius-0" alt="">
							...
							<div class="col-sm-6 col-lg-3 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
								<span class="thumb-info thumb-info-hide-wrapper-bg bg-transparent border-radius-0">
									<span class="thumb-info-wrapper border-radius-0">
										<a href="about-me.html">
											<img src="{{ asset('front/img/team/team-2.jpg') }}" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
							...
							<div class="col-sm-6 col-lg-3 mb-4 mb-sm-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
								<span class="thumb-info thumb-info-hide-wrapper-bg bg-transparent border-radius-0">
									<span class="thumb-info-wrapper border-radius-0">
										<a href="about-me.html">
											<img src="{{ asset('front/img/team/team-3.jpg') }}" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
							...
							<div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
								<span class="thumb-info thumb-info-hide-wrapper-bg bg-transparent border-radius-0">
									<span class="thumb-info-wrapper border-radius-0">
										<a href="about-me.html">
											<img src="{{ asset('front/img/team/team-4.jpg') }}" class="img-fluid border-radius-0" alt="">
											<span class="thumb-info-title">
					...
					<div class="row py-5 my-5">
						<div class="col">
							...
							<div class="owl-carousel owl-theme mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-1.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-2.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-3.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-4.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-5.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-6.png') }}" alt="">
								</div>
								<div>
									<img class="img-fluid opacity-2" src="{{ asset('front/img/logos/logo-4.png') }}" alt="">
								</div>
